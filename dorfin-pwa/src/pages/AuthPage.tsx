...
import { Eye, EyeOff, ChevronLeft, Flame } from 'lucide-react'
    ...
    <div className="min-h-dvh bg-dorfin-bg flex flex-col">
      ...
      <div className="flex flex-col items-center justify-center pt-16 pb-8 px-6">
        ...
        <motion.h1
          ...
          className="font-display text-6xl text-dorfin-text tracking-widest"
        >
          DORFIN
        </motion.h1>
        <motion.p
          ...
          className="text-dorfin-muted text-sm mt-1 text-center"
        >
        ...
        <AnimatePresence mode="wait" custom={direction}>
          ...
          {step === 'email' && (
            <motion.div
              ...
              className="space-y-4"
            >
              <p className="text-dorfin-muted text-sm text-center mb-6">
            ...
            >
              ...
              <form onSubmit={registerForm.handleSubmit(onRegister)} className="space-y-3">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div>
                    <input placeholder="Fecha nacimiento" type="date" className="input-field text-center" {...registerForm.register('fecha_nacimiento')} />
                  </div>
                  <div>
                    <input placeholder="Altura cm" type="number" className="input-field text-center" {...registerForm.register('altura', { valueAsNumber: true })} />
                  </div>
                  <div>
                    <input placeholder="Peso kg" type="number" className="input-field text-center" {...registerForm.register('peso', { valueAsNumber: true })} />
                  </div>
                </div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="Contraseña"
                    className="input-field pr-12"
                    {...registerForm.register('contrasena')}
                  />
                  <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-dorfin-faint">
                    {showPassword ? <EyeOff size={18} /> : <Eye size={18} />}
                  </button>
                </div>

                <input type="password" placeholder="Confirmar contraseña" className="input-field" {...registerForm.register('confirmar')} />
